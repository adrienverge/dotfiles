...
-- Adrien: Choose AdwaitaMono Nerd Font (AdwaitaMono is Gnome Shell's default)
-- from https://www.nerdfonts.com/font-downloads and set in Terminator
vim.g.have_nerd_font = true

vim.o.number = true

-- Adrien: Disable mouse support, I don't like it
vim.o.mouse = ''
...
-- Adrien: Commented out, don't save undo history in files that would stay on disk
-- vim.o.undofile = true
...
-- Adrien: show a vertical bar at textwidth
vim.o.textwidth = 80
...
vim.api.nvim_create_autocmd('BufEnter', {
  pattern = '*',
  command = 'execute "setlocal colorcolumn=" . &l:textwidth',
})
...
vim.keymap.set('n', '<Tab><Tab>3', ':b 3<CR>', { desc = 'Move to buffer 3' })
vim.keymap.set('n', '<Tab><Tab>4', ':b 4<CR>', { desc = 'Move to buffer 4' })
vim.keymap.set('n', '<Tab><Tab>5', ':b 5<CR>', { desc = 'Move to buffer 5' })
vim.keymap.set('n', '<Tab><Tab>6', ':b 6<CR>', { desc = 'Move to buffer 6' })
vim.keymap.set('n', '<Tab><Tab>7', ':b 7<CR>', { desc = 'Move to buffer 7' })
vim.keymap.set('n', '<Tab><Tab>8', ':b 8<CR>', { desc = 'Move to buffer 8' })
vim.keymap.set('n', '<Tab><Tab>9', ':b 9<CR>', { desc = 'Move to buffer 9' })

-- Adrien : Remove trailing spaces when saving
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        ts_ls = {},  -- Adrien: typescript-language-server
  ...
  -- Adrien: I disabled autoformat with 'stevearc/conform.nvim', I don't want it
  -- to rewrite my file everytime I save.
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        -- Adrien: Ctrl+Y to accept the completion, Ctrl+N for next, Ctrl+P for
        -- previous suggestion
        preset = 'default',
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      require('tokyonight').setup {
        styles = {
          -- Adrien: I like italics in comments
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Adrien: I disabled it because it creates lag upon 's' key press
